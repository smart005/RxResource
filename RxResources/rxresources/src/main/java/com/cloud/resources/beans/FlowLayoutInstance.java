...
import com.cloud.resources.flows.LayoutDirection;
...
public class FlowLayoutInstance {
     ...
     * 项文本大小
     */
    private int flowItemTextSize = 12;
    /**
     * 布局方向
     */
    ...
    public int getFlowItemTextSize() {
        return flowItemTextSize;
    }

    public void setFlowItemTextSize(int flowItemTextSize) {
        this.flowItemTextSize = flowItemTextSize;
    }
